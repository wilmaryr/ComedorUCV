...
public class VentanaCostos extends JFrame {
    ...
    private void initComponentes() {
        ...
        centerContainer.add(panelForm, BorderLayout.NORTH);
        centerContainer.add(panelCards, BorderLayout.CENTER);
        ...
        headerPanel.setBackground(new Color(0, 51, 78));
        ...
        JPanel datePanel = new JPanel(new FlowLayout(FlowLayout.RIGHT, 40, 35));
        datePanel.setOpaque(false);
        datePanel.add(dateLabel);

        JLabel lblTitle = new JLabel("Gestionar Costos");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 20));
        lblTitle.setForeground(Color.WHITE);

        JPanel sidesPanel = new JPanel(new BorderLayout());
        sidesPanel.setOpaque(false);
        sidesPanel.setBorder(BorderFactory.createEmptyBorder(0, 40, 0, 0));
        sidesPanel.add(lblTitle, BorderLayout.WEST);
        sidesPanel.add(datePanel, BorderLayout.EAST);
