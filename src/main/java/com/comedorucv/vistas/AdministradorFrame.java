...
public class AdministradorFrame extends JFrame {
    ...
    private void initUI() {
        ...
        JPanel avatarPanel = new JPanel() {
...

            {
                try {
                    ...
                    System.err.println("Error al cargar la foto del administrador: " + e.getMessage());
                }
            }
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (userImage != null) {
                    // Dibujar círculo de fondo por si la imagen tiene transparencia
        ...
        JButton btnListaComensales = createOptionButton("Lista de los comensales");
        btnListaComensales.addActionListener(e -> {
            new VentanaListaComensales(usuario).setVisible(true);
            dispose();
        });
        optionsPanel.add(btnListaComensales);
        ...
        JButton btnHorarios = createOptionButton("Horarios comedor");
        btnHorarios.addActionListener(e -> {
            new VentanaHorarios().setVisible(true);
        });
        optionsPanel.add(btnHorarios);

        JButton btnReporte = createOptionButton("Generar reporte");
        btnReporte.addActionListener(e -> {
            new VentanaReporte(usuario).setVisible(true);
            dispose();
        });
        optionsPanel.add(btnReporte);
